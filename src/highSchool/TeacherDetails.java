...
public class TeacherDetails extends JFrame implements ActionListener {
	...
	JTextField tf;
	JPanel jp;
	String x[] = {"Nome", "Idade", "Nascimento", "CEP", "Celular", "Email", "Série(s)", "Turma(s)", "Graduação", "ID", "Matéria", "Sexo", "CPF"};
	String y[][] = new String[20][13];
	
	int i=0, j = 0;
	
	TeacherDetails() {
		super("Detalhes dos professores");
		jp = new JPanel();
		setSize(1260, 700);
		jp.setLayout(null);
		...
		jp.setBorder(new TitledBorder(new LineBorder(new Color(98, 0, 238), 2), // ((r: g: b:), thickness)
				"Detalhes dos professores", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(55, 0, 179)));
		add(jp);
		
		l1 = new JLabel("Coloque o ID do(a) professor(a)");
		l1.setBounds(300, 360, 300, 20);
		l1.setFont(new Font("futura", Font.BOLD, 20));
		l1.setForeground(Color.WHITE);
		jp.add(l1);
		
		tf = new RoundJTextField(15);
		tf.setBounds(640, 358, 120, 30);
		...
		l2 = new JLabel("Adicionar professores(a)");
